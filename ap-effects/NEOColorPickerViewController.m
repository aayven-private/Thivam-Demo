...
//    [NTTAppDefaults setupSecondaryButton:self.buttonHueGrid];
    ...
    [self.randomSwitch setOn:self.randomizeColor];
    [self.disappearSwitch setOn:self.disappear];
...
- (IBAction)buttonPressDone:(id)sender {
    self.randomizeColor = _randomSwitch.isOn;
    self.disappear = _disappearSwitch.isOn;
    [self.delegate colorPickerViewController:self didSelectColor:self.selectedColor withRandomize:_randomSwitch.isOn withDisappear:_disappearSwitch.isOn];
}
